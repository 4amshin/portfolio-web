...
<body>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="skill-mf">
                                        ...
                                        <span>CSS</span> <span class="pull-right">45%</span>
                                        <div class="progress">
                                            <div class="progress-bar" role="progressbar" style="width: 45%" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <span>Flutter</span> <span class="pull-right">75%</span>
                                        <div class="progress">
                                ...
                                <div class="col-md-6">
                                    <div class="about-me pt-4 pt-md-0">
                                        ...
                                        <p class="lead">
                                            Website ini dibuat menggunakan html, CSS, dan <b>Bootstrap</b>. Website ini dibuat untuk <b>UTS</b> mata kuliah <b>Aplikasi Client-Server</b>. Saya juga mahir dalam desain grafis, seperti membuat spanduk, desain
                                            kemasan, pamflet, template posting media sosial seperti instagram dan lain-lain.
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="title-box text-center">
                            ...
                            <p class="subtitle-a">
                                Sejarah Pendidikan & Sertifikasi
                            </p>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="service-box">
                            <div class="service-ico">
                                <span class="ico-circle"><i class="uil uil-file-graph"></i></span>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="service-box">
                            <div class="service-ico">
                                <span class="ico-circle"><i class="uil uil-file-graph"></i></i></span>
                            </div>
                            <div class="service-content">
                    ...
                    <div class="col-sm-3 col-lg-3">
                        <div class="counter-box counter-box pt-4 pt-md-0">
                            ...
                            <div class="counter-num">
                                ...
                                <span class="counter-text">PROJECT SELESAI</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-lg-3">
                    ...
                    <div class="col-sm-3 col-lg-3">
                        <div class="counter-box pt-4 pt-md-0">
                            ...
                            <div class="counter-num">
                                ...
                                <span class="counter-text">TOTAL PENGHARGAAN</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="title-box text-center">
                            ...
                            <p class="subtitle-a">
                                Kumpulan Beberapa Project Saya
                            </p>
                            <div class="line-mf"></div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="socials">
                                            <ul>
                                                ...
                                                <li><a href="https://www.instagram.com/rely_erlanggah/"><span class="ico-circle"><i class="bi bi-instagram"></i></span></a></li>
                                                <li><a href=""><span class="ico-circle"><i class="bi bi-whatsapp"></i></span></a></li>
                                                <li><a href="https://github.com/4amshin"><span class="ico-circle"><i class="bi bi-github"></i></span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
    ...
    <a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="uil uil-angle-up"></i></a>
